...
public class DroneController : MonoBehaviour
{
    ...
    void ApplyInput()
    {
        Vector3 tilt = new Vector3(-forwardInput, 0f, lateralInput) * tiltSpeed * Time.fixedDeltaTime;
    ...
    void ApplyThrustAndMovement()
    {
        ...
        float additionalThrust = verticalInput * maxThrust;
        
        rb.AddForce(Vector3.up * (hoverForce + additionalThrust), ForceMode.Force);
